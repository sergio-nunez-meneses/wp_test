<?php
/*
* Plugin Name: Random Mode
* Plugin URI: https://random-modes.com/
* Description: A color blindness mode plugin based on https://davidmathlogic.com/colorblind/
* Version: 1.0
* Author: Sergio Nuñez Meneses
* Author URI: http://random-modes.com/
*/

// hook the 'wp_footer' action hook, add the custom function
add_action( 'wp_footer', 'colorblind_mode' );
